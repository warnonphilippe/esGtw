...
export class InvoiceProjectionComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-invoice-projection div table .btn-danger'));
  title = element.all(by.css('jhi-invoice-projection div h2#page-heading span')).first();
...
export class InvoiceProjectionUpdatePage {
  pageTitle = element(by.id('jhi-invoice-projection-heading'));
...
export class InvoiceProjectionDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-invoiceProjection-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-invoiceProjection'));
