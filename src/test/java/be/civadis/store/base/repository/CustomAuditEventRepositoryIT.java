...
import be.civadis.store.base.config.audit.AuditEventConverter;
import be.civadis.store.base.domain.PersistentAuditEvent;
...
import static be.civadis.store.base.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
