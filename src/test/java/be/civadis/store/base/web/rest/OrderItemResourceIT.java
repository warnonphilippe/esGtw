...
import be.civadis.store.base.domain.OrderItem;
import be.civadis.store.base.domain.Product;
import be.civadis.store.base.domain.ProductOrder;
import be.civadis.store.base.repository.OrderItemRepository;
import be.civadis.store.base.service.OrderItemService;
...
import be.civadis.store.base.domain.enumeration.OrderItemStatus;
/**
