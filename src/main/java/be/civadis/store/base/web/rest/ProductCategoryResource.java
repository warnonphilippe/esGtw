...
import be.civadis.store.base.domain.ProductCategory;
import be.civadis.store.base.service.ProductCategoryService;
...
/**
 * REST controller for managing {@link be.civadis.store.base.domain.ProductCategory}.
 */
@RestController
@RequestMapping("/api")
