package be.civadis.store.base.web.rest.pkce;
...
public class InvoiceProjectionGtwResourcePKCE {

    private final Logger log = LoggerFactory.getLogger(InvoiceProjectionGtwResourcePKCE.class);
    ...
    public InvoiceProjectionGtwResourcePKCE(InvoiceProjectionGtwRepository invoiceProjectionGtwRepository) {
