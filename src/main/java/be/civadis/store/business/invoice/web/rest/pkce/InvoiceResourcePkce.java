...
@RestController
@RequestMapping("/pkce")
public class InvoiceResourcePkce {

    private final Logger log = LoggerFactory.getLogger(InvoiceResourcePkce.class);

    private static final String ENTITY_NAME = "invoiceResourcePkce";
    ...
    public InvoiceResourcePkce(InvoiceService invoiceService, InvoiceProjectionGtwExtRepository invoiceRepository, EventGateway eventGateway, QueryGateway queryGateway) {
